...
/**
 * Props for GoogleLoginButton component.
 */
 ...
 *
 * Initiates the OAuth flow by redirecting to the backend auth endpoint.
 * Follows AC1: min 44x44px touch target, clearly visible.
 *
